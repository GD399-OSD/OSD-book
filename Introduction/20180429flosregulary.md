...
Braithwaite tells us that designers should be more transparent in how we work, we should share more, and he starts to scratch the surface -- but does he give us enough to start? Is starting to use Dribbble enough? Even from his point of view while it is available for his wants, it is not used correctly. Are there other ideas and tools that would be effective in accelerating this? Where did the sharing ecosystem present in Open Source software come from? Where does this urge to share come from in the first place?
