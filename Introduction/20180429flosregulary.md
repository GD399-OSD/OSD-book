...
F/LOS in a graphic design context provides alternative tools for the creation of designs (Inkscape, Nodebox), file formats that are easier to port across a range of systems and tools (SVG, XML), and a different ideological framing for the creation of cultural artifact (Free as in Freedom). Through these lenses F/LOS is a useful critical tool for the discipline.
