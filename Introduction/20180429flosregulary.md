...
Braithwaite points to an underused (or misused) website: Dribbble. Dribbble was designed by designers and for designers on the principles of sharing in progress works, or at least the process of creating design works. Braithwaite references a feature of dribbble: the rebound as one visual design equivalent reusing open source code. Reebounding invites taking something someone else has offered up to the community and visually riffing, adding, or remixing it to be shared again (and then potential re-rebounded). In an office or studio or inhouse design department cross person sharing might be happening (basically this is "staying on brand" if you work inhouse [wilson miner]). However, out in the world designer's _do not_ regularly "rebound" each other's work. Another feature of Dribbble is the opportunity on a specific piece or project to have a discussion about the design outcomes. Braithwaite laments that while the system is setup to allow for a real discussion, it is not typically used for anything more than cursory accolades.

Braithwaite tells us that designers should be more transparent in how we work, we should share more, and he starts to scratch the surface -- but does he give us enough to start? Is starting to use Dribbble enough? Even from his point of view while it is available for his wants, it is not used correctly. Are there other ideas and tools that would be effective in accelerating this? Where did the sharing ecosystem present in Open Source software come from? Where does this urge to share come from in the first place? His point of view is clear though -- Visual designer's need better tools or examples to help them collaborate out in the open, not just at their desks or with their studiomates.

## How Bazaar

Braithwaite in his sharing ideas and quick overview of Dribbble summarizes and recontextualizes analysis done by Eric Raymond in _The Cathedral and the Bazaar_. Raymond explains how the process and systems for designing and building the linux kernel created our current systems for what open source is: a distributed community collectively engaging in a tool's advancement. Linus Torvalds, the original programmer behind the linux kernel, practiced several (novel at the time), techniques in sharing and building the Linux codebase.

In _TCATB_ Raymond outlines and explains nineteen points key to linux's and Linus's successes. There are two in particular that better actualize Braithwaite's sentiments. The model Linux development uses Raymond refers to as "the bazaar" meaning its just people mostly unorganized doing what they need ad-hoc and improvised, as opposed to what were considered standard software development methods which are "the cathedral" model -- one individual vision, carefully planned and executed by a large team with strong vertical hierarchy.
...
The early Linux ecosystem was a pool of sharing developers. Updates were released and distributed early and often. People using these early release tools were the same set of people equipped to find problems with the tools and, this is key, actually do something about those problems! By sharing rapidly and without self-conciousness (you couldn't be too self-concious, your changes might make it back to everyone!), Linux improved rapidly and robustly.[is this citeable?] The project maintained a precise vision from Torvalds, he was the end decider of what made it into the official linux release at the end of each day or cycle, but the community would debate best options, offer multiple solutions, and if necessary, go off into their own direction if an impasse was met. (This is part of why there are so many flavors of GNU/Linux today -- if an uncrossable technical or philosophical chasm is met, sometimes groups fissure and two projects are born from one.)[list of linux flavors?] In visual design we are trying to find the best visual solution -- but how often do we through out a partially formed idea and see if anyone can poke holes (or find pain points we didn't plan on) early in the process? This can be done within a studio between colleagues -- as things come together make sure you're passing things around the office -- or it can take place out in the world at large (via something like Dribbble? Github?).

Braithwaite's points draw from Torvalds and Raymond: sharing successes and failures as visual learning opportunities aligns with releasing early and often and allowing your users to help find and fix issues. We as designer's could perhaps engage in designing this way. This might mean involving a client more into the process of how visuals evolve. It could also mean documenting more steps of a design's growth and presenting iterations to an audience, not just final outcomes. It definitely means _not_ being afraid of potential errors or pain points.

How does a designer do this? A tool like Dribbble or Behance allows for the seeing each other's design, maybe tinkering a little bit, maybe conversing about what is working or not, but does it offer the robustness required to the visual design equivalent of a Linux community? Serious, respected designers AREN'T on these platforms. In contemporary design these "bazaar's" aren't deemed the place to put ones professional or competent work, they are seen as places for students, noobs, etc. For Linux and other open programs, the distribution servers ARE where the good, successful people are hanging out and pinning up their work for lack of a better metaphor.

All this sharing back and forth, community bug fixing, iterating and evolving, this did still sound familiar. Where has this existed in designing before?

## Spectacular Vernacular

Linus's Law & release early/release often are referencing older forms of cultural production: vernacular design processes. Stewart Brand's _How Buildings Learn_ dissects vernacular building and describes a process that predates the Linux community, yet sounds uncannily similar. In Brand's view, the vernacular process (which he synonymously refers to as "adaptive building") is a systematic framework for evolving concepts. A culture steadily culminates these frameworks over time. Traditions subsequently arise allowing vernacular designers to reuse the invented forms and methods for common, everyday tasks. Contemporary design typically looks for new or unique solution to a given problem, which is counter-productive to creating traditions.
...
Do I need to do this at the beginning? is the way I cover things enough??? How do we put the same ideas and mechanisms towards the benefit of Graphic Design?
